...
<x-app-layout>
    ...
    {{--requirement details--}}
    <x-container-section>
        @include('requirements.partials.requirement-details')
    </x-container-section>
    ...
    <x-container-section>
        <div class="space-y-2">
            ...
            @include('requirements.partials.requirement-task-table-lists')
        </div>
    </x-container-section>
    ...
    <dialog id="newTaskModal" class="modal modal-bottom sm:modal-middle">
        <div class="modal-box">
            ...
            <form action="{{ route('tasks.store', $requirement->id) }}" method="post" class="space-y-2">
                @csrf
