                    ...
                    <table class="table table-auto">
                        ...
                        @else
                            @foreach($tasks as $task)
                                <tr>
                                    <td class="text-nowrap"><a href="{{ route('tasks.show', $task->id) }}"
                                    ...
                                    <td class="inline-flex gap-2">
                                        <a href="{{ route('tasks.show', $task->id) }}" class="text-green-500 tooltip"
                                           data-tip="View"><i class="fa-regular fa-eye"></i></a>
                                        <a href="{{ route('tasks.edit', $task->id) }}" class="text-blue-500 tooltip"
                                        ...
                                        <form id="delete-task-form" action="{{ route('tasks.destroy', $task->id) }}"
                                              method="post">
                                            @csrf
                                            @method('DELETE')
