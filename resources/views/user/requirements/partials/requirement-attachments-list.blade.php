...
{{--                    <a href="{{ route('attachments.download', $attachment->id) }}" class="text-md text-blue-500 hover:text-blue-700 transition-all"><i class="fa-regular fa-download"></i></a>--}}
                    ...
                    <a href="{{ route('attachments.view', $attachment->id) }}" class="text-md text-green-500 hover:text-green-700 transition-all hover:link">view</a>
                    <a href="{{ route('attachments.download', $attachment->id) }}" class="text-md text-blue-500 hover:text-blue-700 transition-all hover:link">download</a>
                </div>
            </div>
        @endforeach
    </div>
